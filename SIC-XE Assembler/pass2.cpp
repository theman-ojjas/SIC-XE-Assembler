...
int main()
{
  cout << "** NOTE: The Input file and executable (sample.out) should be in same folder **" << endl
       << endl;
  cout << "Enter name of the Input File=";
  cin >> fileName;

  cout << "\nPROCCESSING OPTAB" << endl;
  load_tables();

  cout << "\nIMPLEMENTING Pass 1" << endl;
  cout << "Saving the Intermediate File to 'intermediate" << fileName << "'" << endl;
  cout << "Saving the Error File to 'error_" << fileName << "'" << endl;
  pass1();
  ...
  writestring = "";
  cout << "Creating the Literal Table" << endl;
  ...
  writestring = "";
  cout << "Creating the Block Table" << endl;
  ...
  writeToFile(printtab, writestring);
  cout << "\nImplementing Pass 2" << endl;
  cout << "Saving the Object File to 'object_" << fileName << "'" << endl;
  cout << "Saving the Listing File to 'output_" << fileName << "'" << endl;
  pass2();
}
