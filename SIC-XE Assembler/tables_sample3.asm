...
BUFFEND:-	name:BUFFEND	|address:001033	|relative:00001 
...
EXIT:-	name:EXIT	|address:01053	|relative:00001 
FIRST:-	name:FIRST	|address:00000	|relative:00001 
INPUT:-	name:INPUT	|address:0105A	|relative:00001 
...
RLOOP:-	name:RLOOP	|address:0103C	|relative:00001 
WLOOP:-	name:WLOOP	|address:01064	|relative:00001 

---------------------------------LITERAL TABLE---------------------------------

C'EOF':-	value:C'EOF'	|address:00030 
X'05':-	value:X'05'	|address:01079 
